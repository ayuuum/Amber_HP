...
export const cases: CaseItem[] = [
  {
    ...
    relatedServices: [
      { label: 'AI活用ロードマップ', href: '/service/ai-solution#services' },
      { label: '生成AI研修・内製化', href: '/service/ai-solution#services' },
    ],
  ...
  },
  {
    ...
    relatedServices: [
      { label: 'AIエージェント・システム開発', href: '/service/ai-solution#services' },
      { label: 'FDE・継続改善', href: '/service/ai-solution#process' },
    ],
