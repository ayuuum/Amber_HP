...
export const companyPage = {
  hero: {
    ...
    videoSrc: '/videos/company-hero.mp4',
    imageAlt: '霧に包まれた山並み',
    primaryCta: 'Talk to Amber',
    secondaryCta: 'Our Work',
    secondaryHref: '/cases',
  ...
  profile: {
    heading: 'Company',
    rows: [
      { label: 'Company', value: companyInfo.legalName },
      { label: 'Representative', value: companyInfo.representativeName },
      { label: 'Founded', value: companyInfo.foundedYear },
      { label: 'Business', value: companyInfo.businessDescription },
      { label: 'Bank', value: companyInfo.banks },
      { label: 'Address', value: companyInfo.fullAddress },
      {
        label: 'Contact',
