    ...
    items: [
      {
        ...
        answer:
          '暮らしを支える産業の業務変革を、AIとソフトウェアで実装しています。製造・化学、建設・設備・保守など、現場業務を持つ企業を中心に、業務設計からシステム実装・データ連携まで対応します。',
      },
      {
    ...
    items: [
      {
        ...
        answer:
          '可能です。ただし研修は手段の一つです。実務で使われる状態につながる設計を推奨しています。',
      },
      {
        question: '既存のAIツールや環境にも対応できますか？',
        answer:
          '対応できます。利用中の環境や業務に合わせて、設計・実装・連携を進めます。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          '可能です。一方で、現場で使われ続ける状態まで見据えた業務設計との組み合わせを推奨しています。',
      },
      {
        question: '導入までの期間の目安は？',
        answer:
          '小さく試す場合は数週間、システム構築を含む場合は数ヶ月が目安です。現状ヒアリング後に進め方をご提案します。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          '可能です。既存のIT環境・権限・運用ルールを前提に、現場と情報システム部門の双方が進めやすい形で設計します。詳細はセキュリティページをご覧ください。',
      },
      {
        question: '機密情報の扱いはどうなりますか？',
        answer:
          '扱う情報の範囲と権限を整理し、既存のルールを前提に安全に使える形で進めます。顧客データの汎用モデル学習への無断転用は行いません。詳細はセキュリティページをご覧ください。',
      },
    ],
  },
  {
