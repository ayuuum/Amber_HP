      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-4">
            <div className={`flex items-center gap-2 ${step >= 1 ? 'text-deep-forest-green' : 'text-stone-gray'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step >= 1 ? 'border-deep-forest-green bg-deep-forest-green text-warm-cream' : 'border-stone-gray'}`}>
                {step > 1 ? <CheckCircle2 className="w-5 h-5" /> : '1'}
              </div>
              <span className="text-sm font-semibold hidden sm:inline">基本情報</span>
            </div>
            <div className={`w-12 h-0.5 ${step >= 2 ? 'bg-deep-forest-green' : 'bg-stone-gray'}`} />
            <div className={`flex items-center gap-2 ${step >= 2 ? 'text-deep-forest-green' : 'text-stone-gray'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step >= 2 ? 'border-deep-forest-green bg-deep-forest-green text-warm-cream' : 'border-stone-gray'}`}>
                2
              </div>
              ...
              >
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-deep-forest-green text-warm-cream px-8 py-4 rounded-sm hover:bg-espresso-brown transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
                  >
                    次へ進む
                ...
                >
                  ...
                  <div className="flex gap-4">
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02, y: -2 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 border-2 border-deep-forest-green text-deep-forest-green px-6 py-3 rounded-sm hover:bg-deep-forest-green hover:text-warm-cream transition-colors font-semibold flex items-center justify-center gap-2"
                    >
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02, y: -2 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 bg-deep-forest-green text-warm-cream px-8 py-3 rounded-sm hover:bg-espresso-brown transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                    >
