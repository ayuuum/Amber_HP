...
export default function StatsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-24 px-6 bg-green-dark text-white relative overflow-hidden"
    >
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm p-6 rounded-sm border border-white/20 text-center"
            >
              <div className="mb-4">
