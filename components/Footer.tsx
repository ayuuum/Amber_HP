        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm text-stone-gray">
              <li>
                <motion.div whileHover={{ x: 5 }}>
                  <Link href="/service/consulting/blog" className="hover:text-warm-cream transition-colors block">
                    AI顧問サービス ブログ
                  </Link>
                </motion.div>
              </li>
              <li>
                <motion.div whileHover={{ x: 5 }}>
                  <Link href="/service/training/blog" className="hover:text-warm-cream transition-colors block">
                    生成AI研修 ブログ
                  </Link>
                </motion.div>
              </li>
              <li>
                <motion.div whileHover={{ x: 5 }}>
                  <Link href="/service/saas/blog" className="hover:text-warm-cream transition-colors block">
                    Vertical SaaS ブログ
                  </Link>
                </motion.div>
              </li>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm text-stone-gray">
              <li>
                <motion.div whileHover={{ x: 5 }}>
                  <Link href="/company" className="hover:text-warm-cream transition-colors block">
                    会社について
                  </Link>
                </motion.div>
              </li>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm text-stone-gray">
              <li>
                <motion.div whileHover={{ x: 5 }}>
                  <Link href="/privacy" className="hover:text-warm-cream transition-colors block">
                    プライバシーポリシー
                  </Link>
                </motion.div>
              </li>
              <li>
                <motion.div whileHover={{ x: 5 }}>
                  <Link href="/terms" className="hover:text-warm-cream transition-colors block">
                    利用規約
                  </Link>
                </motion.div>
              </li>
