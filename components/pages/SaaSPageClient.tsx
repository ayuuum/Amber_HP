    ...
    return (
        <main className="min-h-screen pt-24 pb-24 px-6 bg-color-bg">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div className="rounded-sm border border-sequoia-black/12 bg-white p-8 shadow-[0_1px_0_rgba(27,25,22,0.04)]">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {features.map((feature, index) => (
                            <motion.div
                                ...
                                whileHover="hover"
                                className="bg-white p-6 rounded-sm border border-sequoia-black/12 shadow-[0_1px_0_rgba(27,25,22,0.04)]"
                            >
                ...
                <motion.div
                    ...
                    className="bg-white p-4 md:p-8 rounded-sm border border-sequoia-black/12 shadow-[0_1px_0_rgba(27,25,22,0.04)] overflow-hidden mb-24"
                >
