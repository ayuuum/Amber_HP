      ...
      <main className="min-h-screen pt-24 pb-24 px-6 bg-color-bg">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-sequoia-black leading-relaxed space-y-6">
            <section>
              <h2 className="text-2xl font-bold text-sequoia-black mt-8 mb-4">1. 個人情報の取り扱いについて</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-sequoia-black mt-8 mb-4">2. 収集する個人情報</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-sequoia-black mt-8 mb-4">3. 個人情報の利用目的</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-sequoia-black mt-8 mb-4">4. 個人情報の管理</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-sequoia-black mt-8 mb-4">5. 個人情報の第三者提供</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-sequoia-black mt-8 mb-4">6. お問い合わせ</h2>
              <p>
