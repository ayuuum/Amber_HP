...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/service/development/blog`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.6 },
    { url: `${baseUrl}/service/ai-training/blog`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.5 },
